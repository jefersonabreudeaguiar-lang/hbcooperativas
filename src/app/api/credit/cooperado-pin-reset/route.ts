...
import { listPendingCooperadoPinResetRequests } from "@/lib/supabase/contaCoopStorage";
...
export async function GET(request: Request) {
  ...
  const solicitacoes = await listPendingCooperadoPinResetRequests(gate.ctx.supabase, cnpj);
